...
// Role : Présentation de l'entreprise et liens rapides.
// ============================================================
  ...
  return (
    <>
      ...
      <main className="shell space-y-6 py-6">
        ...
        {/* SECTION HERO : Le bandeau principal de bienvenue */}
        <section className="panel hero-card grid items-center gap-6 overflow-hidden p-6 md:grid-cols-[1.2fr_0.8fr] md:p-10">
          <div>
            <p className="chip inline-flex border-white/30 bg-white/10 text-white">Matériaux de construction</p>
            ...
            <p className="mt-4 max-w-xl text-sm text-white/85 md:text-base">
              Interface moderne et logique simple. Consultez les produits, passez des commandes et gérez tout clairement.
            </p>
            
            {/* BOUTONS D'ACTION : Navigation vers les produits ou contact */}
          ...
          {/* PETIT BLOC STATISTIQUES (Visuel uniquement) */}
        ...
        {/* SECTION ARGUMENTS : Les 3 points forts de l'entreprise */}
        <section className="grid gap-4 md:grid-cols-3">
          ...
          <article className="metric-card">
            ...
            <p className="mt-2 text-sm text-[#5d5448]">Sans complexité : un petit formulaire et la commande est envoyée.</p>
          </article>
          <article className="metric-card">
            <p className="chip inline-flex">03</p>
            <h2 className="mt-3 font-display text-xl font-bold">Projets clé en main</h2>
            <p className="mt-2 text-sm text-[#5d5448]">En plus des matériaux, nous réalisons aussi vos projets de construction.</p>
          </article>
        </section>
      </main>
    </>
